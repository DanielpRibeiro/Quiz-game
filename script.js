const perguntas = [
   ...
   {
    pergunta: "01 Sobre o arquivo strings.xml qual a função deste arquivo em um projeto Java Android? \n Sobre as alternativas abaixo qual(is) podemos afirmar que são verdadeiras? \n I – Este arquivo serve parar criarmos constantes literais para usarmos em todo o projeto \n  II – Não é recomendável criar strings via hard-code no projeto, recomenda-se usar a partir deste arquivo \n III – Podem até existir strings duplicadas neste arquivo mas nunca que utilizem o mesmo nome É correto afirmar que estão corretas:",
